...
視聴者は 家のWi-Fiが遅いが、ルーター買い替え前にできる対処を知りたいスマホ・PC利用者。冒頭10秒で損失と共感を提示し、前半は原因分解、中盤は再フック、後半は実行手順、最後は今日やる一手に落とす。各シーンに視聴者が見たい理由、ボケ/疑問/反応、ツッコミ/整理、次への引きを入れた。5分前後のため11シーン、110発話、合計300秒想定で設計した。
