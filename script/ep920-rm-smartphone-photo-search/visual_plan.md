...
- AI画像で作るもの: スマホ画面に写真サムネイルが大量に並び、保証書らしき画像だけが見つからず焦る生活感ある机
...
- visual_goal: 16:9 main image that shows the situation and emotion, not dialogue text.
- AI画像で作るもの: 思い出写真、スクショ、書類写真、一時メモ写真が同じスマホ内で地層のように積み重なる概念ビジュアル
- Remotionで描画するもの: 会話字幕のみ。本文枠の説明テキストや画像キャプションは使わない。
- フリー素材で探すもの: none.
- 画面下部20%安全域: keep empty for characters and subtitles.
- 字幕・キャラとの衝突回避: keep key objects above center or upper-left/upper-right.
...
- visual_goal: 16:9 main image that shows the situation and emotion, not dialogue text.
- AI画像で作るもの: スマホ写真を残す、消す、あとで探すの三つのトレイへ整理する明るい図解風イラスト
- Remotionで描画するもの: 会話字幕のみ。本文枠の説明テキストや画像キャプションは使わない。
- フリー素材で探すもの: none.
- 画面下部20%安全域: keep empty for characters and subtitles.
- 字幕・キャラとの衝突回避: keep key objects above center or upper-left/upper-right.
...
- visual_goal: 16:9 main image that shows the situation and emotion, not dialogue text.
- AI画像で作るもの: 期限切れスクショ、追跡番号、地図メモがスマホから軽く片づいていく爽快な整理シーン
- Remotionで描画するもの: 会話字幕のみ。本文枠の説明テキストや画像キャプションは使わない。
- フリー素材で探すもの: none.
- 画面下部20%安全域: keep empty for characters and subtitles.
- 字幕・キャラとの衝突回避: keep key objects above center or upper-left/upper-right.
...
- visual_goal: 16:9 main image that shows the situation and emotion, not dialogue text.
- AI画像で作るもの: 大事な写真を安全なアルバムへ避難させてから不要写真を整理する安心感あるスマホ画面
- Remotionで描画するもの: 会話字幕のみ。本文枠の説明テキストや画像キャプションは使わない。
- フリー素材で探すもの: none.
- 画面下部20%安全域: keep empty for characters and subtitles.
- 字幕・キャラとの衝突回避: keep key objects above center or upper-left/upper-right.
...
- visual_goal: 16:9 main image that shows the situation and emotion, not dialogue text.
- AI画像で作るもの: 空っぽの細かすぎるアルバムが並び、シンプルな三分類へ戻っていくコミカルな整理ビジュアル
- Remotionで描画するもの: 会話字幕のみ。本文枠の説明テキストや画像キャプションは使わない。
- フリー素材で探すもの: none.
- 画面下部20%安全域: keep empty for characters and subtitles.
- 字幕・キャラとの衝突回避: keep key objects above center or upper-left/upper-right.
...
- visual_goal: 16:9 main image that shows the situation and emotion, not dialogue text.
- AI画像で作るもの: スマホ検索窓、保証書、Wi-Fi、駐車場番号のキーワードがやさしく結びつく検索性の概念図
- Remotionで描画するもの: 会話字幕のみ。本文枠の説明テキストや画像キャプションは使わない。
- フリー素材で探すもの: none.
- 画面下部20%安全域: keep empty for characters and subtitles.
- 字幕・キャラとの衝突回避: keep key objects above center or upper-left/upper-right.
...
- visual_goal: 16:9 main image that shows the situation and emotion, not dialogue text.
- AI画像で作るもの: カレンダーに月一の写真小掃除予定が入り、スクショだけ軽く確認する穏やかな生活シーン
- Remotionで描画するもの: 会話字幕のみ。本文枠の説明テキストや画像キャプションは使わない。
- フリー素材で探すもの: none.
- 画面下部20%安全域: keep empty for characters and subtitles.
- 字幕・キャラとの衝突回避: keep key objects above center or upper-left/upper-right.
...
- visual_goal: 16:9 main image that shows the situation and emotion, not dialogue text.
- AI画像で作るもの: スマホ容量メーター、クラウドの倉庫、探せる状態が別問題だと示す明るい比較イメージ
- Remotionで描画するもの: 会話字幕のみ。本文枠の説明テキストや画像キャプションは使わない。
- フリー素材で探すもの: none.
- 画面下部20%安全域: keep empty for characters and subtitles.
- 字幕・キャラとの衝突回避: keep key objects above center or upper-left/upper-right.
...
- scene_goal: 視聴後すぐ行動
- visual_goal: 16:9 main image that shows the situation and emotion, not dialogue text.
- AI画像で作るもの: 整ったスマホ写真フォルダ、重要情報アルバム、少ないスクショ、達成感のある明るい完了画面
- Remotionで描画するもの: 会話字幕のみ。本文枠の説明テキストや画像キャプションは使わない。
- フリー素材で探すもの: none.
- 画面下部20%安全域: keep empty for characters and subtitles.
- 字幕・キャラとの衝突回避: keep key objects above center or upper-left/upper-right.
